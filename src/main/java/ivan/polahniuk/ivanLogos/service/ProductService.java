...
public class ProductService {
    ...
    private Long save(Product product, ProductRequest request) {
        ...
        if (request.getDescription() != null) {
            ...
            product.setDescription("There is no description");
        }
    ...
    public PageResponse<ProductResponse> findByCriteria(ProductCriteria criteria) {
        Page<Product> page = productRepository.findAll(new ProductSpecification(criteria), criteria.getPaginationRequest().toPageable());
